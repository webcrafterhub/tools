...
const page: FC<pageProps> = ({}) => {
  return (
    <div className="container flex flex-col gap-4 py-10">
      <h1>Privacy Policy of Web Crafter Hub</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Web Crafter HUb.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Web Crafter HUb, accessible from{" "}
            <a href="https://webcrafterhub.com/" rel="external nofollow noopener" target="_blank">
              https://webcrafterhub.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: admin@webcrafterhub.com</li>
      </ul>
    </div>
  );
};
